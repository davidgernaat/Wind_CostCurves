...
setEconCeil=1;              % Do you want to add a cost ceiling for economic potential?
...
windfile=2;                 % 1=Hoogwijk winds (m/s) / 2=NASA wind speeds (m/s)
areafile=2;                 % 1=Hoogwijk file (much smaller in higher lats) / 2=self calculated

CostCeil=0.1;               % Level of cost ceiling $ / kWh
